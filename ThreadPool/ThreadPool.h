//
// Created by Tanzq on 2022-05-26.
//

#ifndef EXERCISECPP_THREADPOOL_H
#define EXERCISECPP_THREADPOOL_H
...
//                std::bind(std::forward<F>(f), std::forward<Args>(args)...)
    ...
    static void Run(){
        ...
        for(int i = 0; i < 8; ++i) {
            results.emplace_back(pool.submit([]() -> int {
...
#endif //EXERCISECPP_THREADPOOL_H
